...
// const getMetricLabel = (metric: ImpactMetricEntry): string => {
//   if (metric.key === 'custom' && metric.customLabel) {
//     return metric.customLabel;
//   }
//   return IMPACT_METRIC_LABELS[metric.key] || metric.key.replace(/_/g, ' ').toUpperCase();
// };
...
// const ProjectsPage = () => {
//   const { projects, filteredProjects, selectedProject, refreshData } = useFilter();
...
//   // Handle add project (alias for handleSaveProject for form submission)
//   const handleAddProject = handleSaveProject;
...
//   // 2. Otherwise use filteredProjects from context (which handles admin vs non-admin)
//   // 3. Apply work filter if set
...
//       : filteredProjects;  // Use filteredProjects which is already filtered by context logic
...
//                       const metric = selectedProjectDetails.impact_metrics?.find(m => m.key === key);
//                       const label = metric ? getMetricLabel(metric) : IMPACT_METRIC_LABELS[key];
//                       return (
//                         <div key={key} className="rounded-xl p-4 border border-emerald-200 bg-emerald-50">
//                           <div className="flex items-center gap-2 mb-2">
//                             <span className="text-emerald-700 font-semibold">{label}</span>
//                           </div>
//                           <p className="text-2xl font-bold text-emerald-600">{value.toLocaleString()}</p>
//                         </div>
//                       );
//                     })}
//                   </div>
...
//                       const label = metric ? getMetricLabel(metric) : IMPACT_METRIC_LABELS[key];
//                       return (
//                         <div key={key} className="rounded-xl p-4 border border-blue-200 bg-blue-50">
//                           <div className="flex items-center gap-2 mb-2">
...
//                                 if (value <= 0) return null;
//                                 const metric = (selectedSubProject.impact_metrics as ImpactMetricEntry[])?.find(m => m.key === key);
//                                 const label = metric ? getMetricLabel(metric) : IMPACT_METRIC_LABELS[key];
//                                 return (
//                                   <div key={`sub-${key}`} className="rounded-xl p-3 border border-emerald-200 bg-emerald-50">
//                                     <div className="flex items-center gap-2 mb-1">
//                                       <span className="text-sm font-semibold text-emerald-700">{label}</span>
//                                     </div>
//                                     <p className="text-xl font-bold text-emerald-600">{value.toLocaleString()}</p>
//                                   </div>
//                                 );
//                               })}
//                             </div>
...
//                                 const label = metric ? getMetricLabel(metric) : IMPACT_METRIC_LABELS[key];
//                                 return (
//                                   <div key={`sub-secondary-${key}`} className="rounded-xl p-3 border border-blue-200 bg-blue-50">
//                                     <div className="flex items-center gap-2 mb-1">
...
//           {/* Toll Selection - Only show if tolls are available */}
//           {formData.csrPartnerId && tolls.length > 0 && (
//             <label className="text-sm font-medium text-gray-700">
//               Toll / Subcompany
//               {tollsLoading ? (
//                 <div className="mt-1 flex items-center gap-2 text-gray-500">
...
//                   onChange={(e) => setFormData((prev) => ({ ...prev, tollId: e.target.value }))}
//                   className="mt-1 w-full rounded-xl border border-gray-200 px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
//                 >
...
//                   teamMembers: [
//                     ...prev.teamMembers,
//                     { userId: '', role: 'team_member' as ProjectTeamRole },
//                   ],
//                 }))
//               }
//               className="text-xs px-3 py-1 rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100"
//             >
//               + Add Member
//             </button>
//           </div>
...
//                   }}
//                   className="flex-1 text-sm rounded-lg border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-emerald-500"
//                 >
...
//                   onChange={(e) => {
//                     const updated = [...formData.teamMembers];
//                     updated[idx].role = e.target.value as ProjectTeamRole;
//                     setFormData((prev) => ({ ...prev, teamMembers: updated }));
//                   }}
//                   className="text-sm rounded-lg border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-emerald-500"
//                 >
...
//                   type="button"
//                   onClick={() => {
//                     const updated = formData.teamMembers.filter((_, i) => i !== idx);
//                     setFormData((prev) => ({ ...prev, teamMembers: updated }));
//                   }}
...
//                   impactMetrics: [
//                     ...prev.impactMetrics,
//                     { key: PREDEFINED_METRIC_KEYS[0], value: 0, customLabel: '' },
//                   ],
//                 }))
//               }
//               className="text-xs px-3 py-1 rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100"
...
//                     updated[idx].key = e.target.value as ImpactMetricKey;
...
//                     setFormData((prev) => ({ ...prev, impactMetrics: updated }));
//                   }}
//                   className="w-20 text-sm rounded-lg border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-emerald-500"
//                 />
//                 <button
//                   type="button"
//                   onClick={() => {
//                     const updated = formData.impactMetrics.filter((_, i) => i !== idx);
//                     setFormData((prev) => ({ ...prev, impactMetrics: updated }));
//                   }}
//                   className="px-2 py-2 text-red-600 hover:bg-red-50 rounded"
//                 >
...
//           />
//           Create Beneficiary Sub-Projects
//         </label>

-- ============================================
-- Update Ravi Singh with ONE Role Per Project (Different Roles Across Projects)
-- ============================================

-- Step 1: Update Ravi Singh's password
UPDATE public.users 
SET password = 'ravi123'
WHERE username = 'ravi.singh';

-- Step 2: Update Ravi Singh's role for each project (ONE role per project)
-- For Project 1 (EDU-2025-001): ACCOUNTANT
